...
const PORTRAITS={
  'ahmose':'/portraits/ahmose.png',
  'aiden':'/portraits/aiden.png',
  'aisling':'/portraits/aisling.png',
  'alonso':'/portraits/alonso.png',
  'bahiti':'/portraits/bahiti.png',
  'bertha':'/portraits/bertha.png',
  'blanchette':'/portraits/blanchette.jpg',
  'bradley':'/portraits/bradley.jpg',
  'cara':'/portraits/cara.png',
  'charlie':'/portraits/charlie.png',
  'cloris':'/portraits/cloris.png',
  'dominic':'/portraits/dominic.png',
  'edith':'/portraits/edith.jpg',
  'eleanor':'/portraits/eleanor.png',
  'eleonora':'/portraits/eleonora.jpg',
  'elif':'/portraits/elif.png',
  'estrella':'/portraits/estrella.png',
  'eugene':'/portraits/eugene.png',
  'flint':'/portraits/flint.png',
  'flora':'/portraits/flora.jpg',
  'fred':'/portraits/fred.jpg',
  'freya':'/portraits/freya.jpg',
  'gatot':'/portraits/gatot.jpg',
  'gina':'/portraits/gina.png',
  'gisela':'/portraits/gisela.jpg',
  'gordon':'/portraits/gordon.jpg',
  'greg_s3':'/portraits/greg_s3.png',
  'gregory':'/portraits/gregory.jpg',
  'gwen':'/portraits/gwen.jpg',
  'hank':'/portraits/hank.png',
  'hector':'/portraits/hector.jpg',
  'hendrik':'/portraits/hendrik.jpg',
...
// ── HERO CARD (compact) ───────────────────────────────────────
function HeroCard({hero,state,onToggle,onStars,onUpload}){
  const imgSrc=getPortrait(hero.id)||null; // static portrait first
  ...
  return(
    <div style={{background:owned?g.bg:'#0a0615',border:`1.5px solid ${owned?g.border:'#1d0d30'}`,
      ...
      {onUpload&&!getPortrait(hero.id)&&<label onClick={e=>e.stopPropagation()} style={{position:'absolute',top:3,right:3,
        width:18,height:18,borderRadius:4,background:'#2d1a4a',
...
function MiniHero({heroId,heroStates,heroImages,label}){
  // static portrait takes priority
  if(!heroId)return(
  ...
  const hero=HMAP[heroId],g=GRP[hero.g],stars=heroStates?.[heroId]?.stars??0,imgSrc=getPortrait(heroId)||heroImages?.[heroId];
  return(
